...
#DEFAULT_INPUT_DIR = os.getenv('INPUT_DIR', ".")
...
def main():
    ...
    report_filename = os.path.join(report_dir, "eks_upgrade_report.html")
    
    # report_filename = os.path.join(input_dir, "eks_upgrade_report.html")
    ...
    # shutil.copy(report_filename, target_dir)
    # print(f"Location: {os.path.abspath(report_filename)}")
    # print(f"Copied to: {os.path.abspath(os.path.join(target_dir, report_filename))}")
